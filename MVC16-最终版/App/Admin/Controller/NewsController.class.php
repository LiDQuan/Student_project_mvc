<?php
    ...
    final class NewsController extends BaseController{
        ...
        public function delete(){
            ...
            if($result){
                $this->jump("<h2>新闻数据删除成功</h2>,三秒后跳转", "?p=Admin&c=News");
            }else{
                $this->jump("<h2>删除数据失败，请检查输入是否正确</h2>", "?p=Admin&c=News");
            }
        }
        ...
        public function update(){
            ...
            if($this->new->update($arr, $nid)){
                $this->jump("新闻修改成功", "?p=Admin&c=News");
            }else{
                $this->jump("<h2>新闻修改失败</h2>", "?p=Admin&c=News");
            }
        }
        ...
        public function insert(){
            ...
            if($this->new->insertdata($arr_data)){
                $this->jump("新闻插入成功", "?p=Admin&c=News");
            }else{
                $this->jump("<h2>新闻插入数据失败</h2>", "?p=Admin&c=News");
            }
        }
    }
?>